...
try {
    ...
    INSERT INTO comanda_items
        (comanda_id, batch_id, item_id, uid, tipo, combo_id, producto_id, variante_id, extra_id, nombre, qty, precio, nota, added_at, destino)
    VALUES
        (:comanda_id, :batch_id, :item_id, :uid, :tipo, :combo_id, :producto_id, :variante_id, :extra_id, :nombre, :qty, :precio, :nota, :fecha, :destino)
    ");
