...
try {
    ...
    foreach ($comandas as $comanda) {
        ...
        foreach ($batches as $batch) {
            ...
            $stmtI = $cnx->prepare("SELECT * FROM comanda_items WHERE comanda_id = :cid AND batch_id = :bid AND (destino = 'Cocina' OR destino = 'Ambos') AND ready_cocina = 0 AND tipo != 'extra' ORDER BY id ASC");
