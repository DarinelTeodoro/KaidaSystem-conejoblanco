...
if (empty($_SESSION['data-useractive'])) {
    ...
    if ($day >= 01 && $day <= 05) {
        ...
        if ($recordatorio['visto_cocina'] == 0) {
            $recordar = 1;
        } else if ($recordatorio['visto_cocina'] == 1) {
            $recordar = 0;
        }
    } else {
        $recordar = 0;
...
<head>
    ...
    <title>Restaurante "El Retoño" - Cocina</title>
...
<body id="body-page">
    <div class="system_navbar_general fixed-top">
        ...
        <div class="d-flex align-items-center justify-content-between dropdown">
            ...
            <div class="navbar_box_user" type="button" data-bs-toggle="dropdown" data-bs-auto-close="false"
                aria-expanded="false">
    ...
    if ($recordar == 1) {
        ...
        <form method="post" action="" id="item-recordatorio" class="recordatorio bg-warning visible">
            ...
            <input type="hidden" name="ubicacion" value="cocina">
            <div>
